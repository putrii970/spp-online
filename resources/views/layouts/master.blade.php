                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Kejuruan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Petugas</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Kelas</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Pembayaran</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">History</a></li>
                            <li><i class="fa fa-file-word-o"></i><a href="ui-typgraphy.html">Laporan</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
